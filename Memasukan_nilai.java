...
public static void main(String[] args) {
    ...
    ArrayList<Mahasiswa> kumpulanMahasiswa = new ArrayList<Mahasiswa>();
    ...
    while (index != jumlahPeserta) {
      ...
      kumpulanMahasiswa.add(new Mahasiswa(nim, nama, nilai));
      index += 1;
    }

    Exam ujian = new Exam();
    ujian.setStudents(kumpulanMahasiswa); 
    ujian.getExamResult();
  }
